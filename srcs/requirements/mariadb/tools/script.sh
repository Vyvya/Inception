...
# Check if a marker file indicating installation completion exists
if [ ! -f /var/lib/mysql/installed.txt ]; then
    # The installation steps should be executed only once
...
EOF
    ...
    # Create a marker file to indicate that installation has been completed
    touch /var/lib/mysql/installed.txt
fi
